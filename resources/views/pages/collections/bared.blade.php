...
{{--    </section>--}}
    ...
    <section class="collection-images grid col-3 gap-10" id="preview-collection">
        <img src="{{ asset('assets/images/collections/bared/01.jpg') }}" alt="">
        <img src="{{ asset('assets/images/collections/bared/02.jpg') }}" alt="">
        <img src="{{ asset('assets/images/collections/bared/03.jpg') }}" alt="">
        <img src="{{ asset('assets/images/collections/bared/04.jpg') }}" alt="">
        <img src="{{ asset('assets/images/collections/bared/05.jpg') }}" alt="">
        <img src="{{ asset('assets/images/collections/bared/06.jpg') }}" alt="">
        <img src="{{ asset('assets/images/collections/bared/07.jpg') }}" alt="">
        <img src="{{ asset('assets/images/collections/bared/08.jpg') }}" alt="">
        <img src="{{ asset('assets/images/collections/bared/09.jpg') }}" alt="">
    </section>
@endsection
